...
public class AppModule {
    ...
    public SignatureKey signatureKey() {
         return new SignatureKey("ebrithilapi 19b17d15-8019-4616-97f1-85c75eb6221d EbrithilAPI 1184939745113343224".getBytes(Charsets.UTF_8));
    }
    ...
    public ConfigSupplier appConfigSupplier(ConfigLoader configLoader) {
        // Load settings.properties in ebrithilapi package as a set of config entries
        return configLoader.fromResource("ebrithilapi/settings");
    }
